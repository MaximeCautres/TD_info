...
(*
pour carrŽ :c rŽpte 4 [av :c td 90].
      pour multi_carrŽ :c :n rŽpte :n [carrŽ :c td 10].
      ve multi_carrŽ 80 10 .
...
boucle()
(* l'instruction "boucle" prŽcŽdente ayant lancŽ l'interprŽteur
   minilogo, il suffit de cliquer sur le bouton "send" pour
   exŽcuter le programme minilogo suivant; cliquer sur le bouton
