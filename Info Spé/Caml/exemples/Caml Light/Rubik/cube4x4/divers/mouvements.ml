include "exemples/Caml Light/Rubik/cube4x4/divers/indices.ml";;
include "exemples/Caml Light/Rubik/divers/groupe_des_mouvements.ml";;
include "exemples/Caml Light/Rubik/divers/groupe_du_cube.ml";;
