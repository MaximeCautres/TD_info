...
let boucle1 cube action1 action2 action3 =
	...
	try
		cube.dessine1 ();
		cree_boutons1 cube;
		let largeur, hauteur = graphics__text_size "Quitter"
		and largeur1, hauteur1 = graphics__text_size "Mélanger"
		and largeur2, hauteur2 = graphics__text_size "Résolution simple"
		and largeur3, hauteur3 = graphics__text_size "Résolution complète"
		
		in
			let bouton_quitter = bouton "Quitter" (graphics__size_x () - largeur - 20) (graphics__size_y () - hauteur - 20)
				(largeur + 10) (hauteur + 10) graphics__yellow (fun () -> raise Quitter)
			and
			bouton_melanger = bouton "Mélanger" ((graphics__size_x () - largeur1) / 2 - 10) (graphics__size_y () - hauteur1 - 20)
				(largeur1 + 10) (hauteur1 + 10) graphics__yellow action1
			and
			bouton_resoudre1 = bouton "Résolution simple" 20 (graphics__size_y () - hauteur2 - 20)
				(largeur2 + 10) (hauteur2 + 10) graphics__yellow action2
			and
			bouton_resoudre2 = bouton "Résolution complète" 20 (graphics__size_y () - hauteur3 - 60)
				(largeur3 + 10) (hauteur3 + 10) graphics__yellow action3
			in
