...
let main() =
  open_graph "";
(*  set_window_title "colwheel"; *)
  let (msg_w, msg_h) = text_size "Select window and press 'q' to quit    R=999 G=999 B=999" in
  try
    wheels max;
    set_color foreground;
    moveto 0 0; draw_string "Select window and press 'q' to quit";
    while true do
      let e = wait_next_event [Button_down; Key_pressed] in
        ...
        if e.button then begin
          ...
          let r = c lsr 16 and g = (c lsr 8) land 255 and b = c land 255 in
            ...
            set_color foreground;
            moveto 0 0;
            draw_string ("Select window and press 'q' to quit    R=" ^ string_of_int r ^
