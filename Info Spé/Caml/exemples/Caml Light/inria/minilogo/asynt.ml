...
and ordre = function
  ...
  | [< 'Mot "stop" >] -> Stop
  | [< 'Mot "si"; expression e1; 'Symbole `>`; 'Symbole `=`; expression e2;
        liste_d'ordres alors; liste_d'ordres sinon >] -> Si (e1, e2, alors, sinon) 
  | [< '(Mot "répète" | Mot "rep");        expression e; liste_d'ordres l >] -> Rep (e,l)
